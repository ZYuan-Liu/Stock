...
public class ContentAdapter extends RecyclerView.Adapter<ContentAdapter.ItemViewHolder> {
    ...
    private List<SelectionBean> datas;
    ...
    public void setDatas(List<SelectionBean> datas) {
        this.datas = datas;
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.fragment_selection_item1, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ItemViewHolder itemViewHolder, int i) {
        ...
        itemViewHolder.tvLeftCode.setText(datas.get(i).getLeftCode());
        //右边滑动部分
        ...
        itemViewHolder.ll_item.setOnClickListener(new NoDoubleClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
                Intent intent = new Intent(context, StockWeb.class);
                intent.putExtra("code", itemViewHolder.tvLeftCode.getText());
                intent.putExtra("name", itemViewHolder.tvLeftTitle.getText());
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(@NonNull View itemView) {
            super(itemView);
            tvLeftCode = itemView.findViewById(R.id.tv_stock_id);
